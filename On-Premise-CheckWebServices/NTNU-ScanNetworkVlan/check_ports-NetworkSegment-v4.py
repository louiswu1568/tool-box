...
# IP 列表文件和輸出文件的位置
ip_file_path = "/home/kali/Sys/ScanNetworkVlan/ScanNetwork_Vlan-v1.txt"  # CIDR 或 IP 地址的清單
output_file_path = "/home/kali/Sys/ScanNetworkVlan/ScanNetwork_Vlan-final-result.xlsx"
